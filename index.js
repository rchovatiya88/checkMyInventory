...
var APP_ID = 'amzn1.ask.skill.fd49c0de-9248-448d-95b7-388e06ad5959';
...
function onLaunch(launchRequest, session, response) {
  ...
  response.speechText = "Boss, would you like to check your inventory,<break time='300ms'/> better re up before you out of stock, <break time='200ms'/> you feal!";
  response.repromptText = "you can ask me to check email";
